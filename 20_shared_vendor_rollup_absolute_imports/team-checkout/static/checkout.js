...
var CheckoutBuy = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(CheckoutBuy, [{
    ...
    value: function connectedCallback() {
      this.setAttribute("data-version", "Zespół Zakupów (React v".concat(React.version, ")"));
      this.render();
    }
  }, {
...
console.log("Zespół Zakupów - React v".concat(React.version));
